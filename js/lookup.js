    ...
    for (const chunk of chunks) {
        await Promise.all(chunk.map(async (i) => {
            ...
            if (id < V2_START) {
                ...
                contractID = id - V2_START;
            }
            if (collectionsData[String(id)]["discord-required"] == "true") {
                let eventFilterName = marketContract.filters.PurchasedWithName(contractID);
                ...
                let eventFilter = marketContract.filters.Purchase(contractID);
